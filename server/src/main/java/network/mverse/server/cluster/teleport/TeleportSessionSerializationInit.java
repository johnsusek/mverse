...
public class TeleportSessionSerializationInit implements SerializationContextInitializer {
   @Override
   public String getProtoFileName() {
      return "teleportSession.proto";
   }
   ...
   public void registerMarshallers(SerializationContext serCtx) {
      serCtx.registerMarshaller(new TeleportSessionMarshaller());
   }
}
